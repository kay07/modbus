    ...
    public <T> void setValue(BaseLocator<T> locator, Object value) throws ModbusTransportException,
        ...
        if (registerRange == RegisterRange.COIL_STATUS) {
            ...
            if (locator.getDataType() == DataType.BINARY) {
                ...
                boolean swa=false;
                if(locator.getDataType()==DataType.FOUR_BYTE_FLOAT_SWAPPED||
                        locator.getDataType()==DataType.EIGHT_BYTE_FLOAT_SWAPPED||
                        locator.getDataType()==DataType.FOUR_BYTE_INT_SIGNED_SWAPPED ){
                    swa=true;
                }
                ...
                if (data.length == 1 && !multipleWritesOnly)
                    ...
                    setValue(new WriteRegistersRequest(slaveId, writeOffset, data,swa));
            }
        }
