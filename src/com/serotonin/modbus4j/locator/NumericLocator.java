...
public class NumericLocator extends BaseLocator<Number> {
    ...
    public Number bytesToValueRealOffset(byte[] data, int offset) {
        ...
        if (dataType == DataType.EIGHT_BYTE_FLOAT_SWAPPED)
            return Double.longBitsToDouble(((long) ((data[offset + 7] & 0xff)) << 56)
                    | ((long) ((data[offset + 6] & 0xff)) << 48) | ((long) ((data[offset + 5] & 0xff)) << 40)
                    | ((long) ((data[offset + 4] & 0xff)) << 32) | ((long) ((data[offset + 3] & 0xff)) << 24)
                    | ((long) ((data[offset + 2] & 0xff)) << 16) | ((long) ((data[offset +1] & 0xff)) << 8)
                    | ((data[offset ] & 0xff)));
